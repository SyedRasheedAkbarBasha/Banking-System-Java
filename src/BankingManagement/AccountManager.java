...
public class AccountManager {
    ...
    public void debit_money(long account_number) throws SQLException {
        ...
        // 🛠️ FIX 1: Clear buffer after sc.nextLong()
        sc.nextLine();
                ...
                try (ResultSet res = selectSmt.executeQuery()) {
                    if(res.next()){
                        ...
                        if(currentBalance >= amount){
                            ...
                            // 🛠️ FIX 3: Use separate PreparedStatement (debitSmt) for the update
            ...
            try (PreparedStatement selectSmt = con.prepareStatement(selectQuery)) {
                ...
                try (ResultSet res = selectSmt.executeQuery()) {
                    if(res.next()){
                        ...
                        // 🛠️ FIX 3: Use separate PreparedStatement (creditSmt) for the update
        ...
        try{
            ...
            try (PreparedStatement smt = con.prepareStatement(query)) {
                ...
                try (ResultSet res = smt.executeQuery()) {
                    if (res.next()){
                        // 🛠️ FIX 4: Changed getInt to getDouble for balance consistency
    ...
    public void transferMoney(long senderAccountNumber){
        ...
        // 🛠️ FIX 1: Clear buffer after sc.nextDouble()
        sc.nextLine();
                    ...
                    try (ResultSet res = smt.executeQuery()) {
                        if (res.next()) {
                            ...
                            if (senderCurrentBalance >= amount) {
                                ...
                                // 🛠️ FIX 2: Use try-with-resources for two PreparedStatements
                                try (PreparedStatement debitSmt = con.prepareStatement(debit_query);
    ...
    // This helper method was correctly added in your original provided code and remains correct.
